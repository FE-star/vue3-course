...
export function getPreviewHTML(
  ...
  if (fs.existsSync(htmlPath) && fs.statSync(htmlPath).isFile()) {
    ...
    let injectMap = {
      bundle: {
        before: `<link href="/public/cdn/page/${pageUuid}/${version}/bundle.css" rel="stylesheet" />
        <script src="/public/cdn/pkg/vue/3.2.45/dist/vue.runtime.global.js"></script>`,
        after: `<script src="/public/cdn/page/${pageUuid}/${version}/bundle.js"></script>`
      },
      esm: {
        before: `<link href="/public/cdn/page/${pageUuid}/${version}/bundle.css" rel="stylesheet" />`,
        after:
    ...
    if (process.env.NODE_ENV === 'development') {
      injectMap = {
        ...
        esm: {
          before: `
          <script type="module" src="/@vite/client"></script>
          <link href="/public/cdn/page/${pageUuid}/${version}/bundle.css" rel="stylesheet" />`,
          after:
            '<script type="module" src="/public/esm/preview-esm.js"></script>'
        },
        amd: {
