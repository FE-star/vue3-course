...
import sqlLogInfo from './sql/log_info.sql?raw';
...
async function initDatabase() {
  ...
  await queryDatabaseSQLByPool(sqlLogInfo);
  console.log(`运营搭建平台 - 数据库 ${database} 建表 log_info 成功！`);

  console.log(`运营搭建平台 - 数据库 ${database} 建表完成！`);
